...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted, user_full_name, user_account_type FROM users";
    ...
    public static function getPublicProfileOfUser($user_name)
    {
        ...
        $sql = "SELECT user_id, user_name, user_full_name, user_email, user_active, user_has_avatar, user_deleted, user_full_name
    ...
    public static function getUserDataByUserNameOrEmail($user_name_or_email)
    {
        ...
        $query = $database->prepare("SELECT user_id, user_name, user_email, user_full_name, FROM users
    ...
    public static function userMode()
    {
        $database = DatabaseFactory::getFactory()->getConnection();
        $query = $database->prepare("SELECT * FROM users WHERE user_id = :user_id");
        $query->execute(array(':user_id' => Session::get('user_id')));

        return $query->fetch()->user_dash_mode;
    ...
    public static function deactivate()
    {
        ...
        $sql = "UPDATE users SET user_deleted = 1 WHERE user_id = :user_id";

        $query = $database->prepare($sql);

        if($query -> execute(array(':user_id'=> Session::get("user_id")))){
            return true;
        }else{
            return false;
        }
