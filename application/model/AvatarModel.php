...
class AvatarModel
{
    ...
    public static function createAvatar()
    {
        ...
        if(Request::post('user_full_name') != Request::userFullName()){
          $full_name = Request::post('user_full_name');
          ...
          if ($query->rowCount() == 1) {
              Session::add('feedback_positive', "Profile successfully updated");
              return true;
          }else{
            Session::add('feedback_negative', $full_name);
            return false;
          }
        }
        Session::add('feedback_positive', "Profile successfully updated");
     ...
     */
    public static function resizeAvatarImage($source_image, $destination, $final_width = 200, $final_height = 200)
    {
