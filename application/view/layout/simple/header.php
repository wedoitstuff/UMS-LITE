                    ...
                    <div class="aside-user mb-5 mb-lg-10" id="kt_aside_user">
                        ...
                        <div class="d-flex align-items-center flex-column">
                            ...
                            <div class="text-center">
                                <!--begin::Username-->
                                <a href="user" class="text-gray-900 text-hover-primary fs-4 fw-boldest"><?= Request::userFullName(); ?></a>
                                <!--end::Username-->
                                <!--begin::Description-->
                                <span class="text-gray-600 fw-bold d-block fs-7 mb-1"><?= Request::userLevelByInt($this->user_account_type); ?></span>
                                <!--end::Description-->
                            </div>
                            <!--end::Info-->
                        </div>
...
<!--													</div>-->
                    ...
                    <div class="aside-footer flex-column-auto px-6 px-lg-9" id="kt_aside_footer">
                        ...
                        <div class="d-flex flex-stack ms-7">
                            <!--begin::Link-->
                            <a href="login/logout" class="btn btn-sm btn-icon btn-active-color-primary btn-icon-gray-600 btn-text-gray-600">
