...
class View
{
    ...
    public function render($filename, $data = null)
    {
        ...
        require Config::get('PATH_VIEW') . 'layout/' . Config::get('THEME') . '/header.php';
        require Config::get('PATH_VIEW') . 'content/' . $filename . '.php';
        require Config::get('PATH_VIEW') . 'layout/'  . Config::get('THEME') . '/footer.php';
    }
    ...
    public function renderMulti($filenames, $data = null)
    {
        ...
        require Config::get('PATH_VIEW') . 'layout/' . Config::get('THEME') . '/_templates/footer.php';

        foreach($filenames as $filename) {
            require Config::get('PATH_VIEW') . 'content/' . $filename . '.php';
        }

        require Config::get('PATH_VIEW') . 'layout/' . 'layout/' . Config::get('THEME') . '/footer.php';
    }
    ...
    public function renderFeedbackMessages()
    {
        ...
        require Config::get('PATH_VIEW') . 'layout/' . Config::get('THEME') . '/feedback.php';
