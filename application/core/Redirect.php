...
class Redirect
{
     ...
     * by Redirect::to() when using User Managment inside sub-folders.
     *
     * @param $path string
     */
     ...
     *
     * Redirects to a RELATIVE path, like "user/profile" (which works very fine unless you are using User managment inside tricky
