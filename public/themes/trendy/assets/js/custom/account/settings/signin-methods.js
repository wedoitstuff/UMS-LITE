...
var KTAccountSettingsSigninMethods = function () {
    ...
    var initSettings = function () {
        ...
        var profileMainEl = document.getElementById('kt_signin_profile');
        var profileEditEl = document.getElementById('kt_signin_profile_edit');
        ...
        var profileChange = document.getElementById('kt_signin_profile_button');
        ...
        profileChange.querySelector('button').addEventListener('click', function () {
            toggleChangeProfile();
        });
